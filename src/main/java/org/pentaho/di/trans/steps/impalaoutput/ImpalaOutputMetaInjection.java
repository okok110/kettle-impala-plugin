 ...
 */
@Deprecated
public class ImpalaOutputMetaInjection implements StepMetaInjectionInterface {
  ...
  public ImpalaOutputMetaInjection( ImpalaOutputMeta meta ) {
    this.meta = meta;
  }
  ...
  public ImpalaOutputMeta getMeta() {
    return meta;
  }
}
