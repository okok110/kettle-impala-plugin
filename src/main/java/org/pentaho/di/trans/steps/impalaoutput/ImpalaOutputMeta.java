...
@Step(
        id = "ImpalaOutput",
        name = "ImpalaOutput.Name",
        description = "ImpalaOutput.TooltipDesc",
...
@InjectionSupported( localizationPrefix = "ImpalaOutputMeta.Injection.", groups = { "DATABASE_FIELDS" } )
public class ImpalaOutputMeta extends BaseStepMeta implements StepMetaInterface, ProvidesModelerMeta {
  ...
  public Object clone() {
    ...
    ImpalaOutputMeta retval = (ImpalaOutputMeta) super.clone();
  ...
  public void check( List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta,
    ...
    if ( databaseMeta != null ) {
      CheckResult cr =
        new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(
          PKG, "ImpalaOutputMeta.CheckResult.ConnectionExists" ), stepMeta );
      remarks.add( cr );
      ...
      try {
        ...
        cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(
            PKG, "ImpalaOutputMeta.CheckResult.ConnectionOk" ), stepMeta );
        remarks.add( cr );
        ...
        if ( !Utils.isEmpty( tableName ) ) {
          ...
          if ( db.checkTableExists( realSchemaName, realTableName ) ) {
            cr =
              new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(
                PKG, "ImpalaOutputMeta.CheckResult.TableAccessible", schemaTable ), stepMeta );
            remarks.add( cr );
            ...
            if ( r != null ) {
              cr =
                new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(
                  PKG, "ImpalaOutputMeta.CheckResult.TableOk", schemaTable ), stepMeta );
              remarks.add( cr );
              ...
              if ( prev != null && prev.size() > 0 ) {
                cr =
                  new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(
                    PKG, "ImpalaOutputMeta.CheckResult.FieldsReceived", "" + prev.size() ), stepMeta );
                remarks.add( cr );
                ...
                if ( !specifyFields() ) {
                  ...
                  if ( error_found ) {
                    error_message =
                      BaseMessages.getString(
                        PKG, "ImpalaOutputMeta.CheckResult.FieldsNotFoundInOutput", error_message );
                    ...
                    cr =
                      new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(
                        PKG, "ImpalaOutputMeta.CheckResult.AllFieldsFoundInOutput" ), stepMeta );
                    remarks.add( cr );
                  }
                } else {
                  ...
                  if ( error_found ) {
                    error_message =
                      BaseMessages.getString(
                        PKG, "ImpalaOutputMeta.CheckResult.FieldsSpecifiedNotInTable", error_message );
                ...
                if ( !specifyFields() ) {
                  ...
                  if ( error_found ) {
                    error_message =
                      BaseMessages.getString( PKG, "ImpalaOutputMeta.CheckResult.FieldsNotFound", error_message );
                    ...
                    cr =
                      new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(
                        PKG, "ImpalaOutputMeta.CheckResult.AllFieldsFound" ), stepMeta );
                    remarks.add( cr );
                  }
                } else {
                  // Specifying the column names explicitly
                  ...
                  if ( error_found ) {
                    error_message =
                      BaseMessages.getString(
                        PKG, "ImpalaOutputMeta.CheckResult.FieldsSpecifiedNotFound", error_message );
                ...
                cr =
                  new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(
                    PKG, "ImpalaOutputMeta.CheckResult.NoFields" ), stepMeta );
                remarks.add( cr );
              }
            } else {
              cr =
                new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(
                  PKG, "ImpalaOutputMeta.CheckResult.TableNotAccessible" ), stepMeta );
              remarks.add( cr );
            }
          } else {
            cr =
              new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(
                PKG, "ImpalaOutputMeta.CheckResult.TableError", schemaTable ), stepMeta );
            remarks.add( cr );
          }
        } else {
          cr =
            new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(
              PKG, "ImpalaOutputMeta.CheckResult.NoTableName" ), stepMeta );
          remarks.add( cr );
        }
      } catch ( KettleException e ) {
        cr =
          new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(
            PKG, "ImpalaOutputMeta.CheckResult.UndefinedError", e.getMessage() ), stepMeta );
        remarks.add( cr );
      } finally {
        db.disconnect();
      }
      ...
      CheckResult cr =
        new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(
          PKG, "ImpalaOutputMeta.CheckResult.NoConnection" ), stepMeta );
      remarks.add( cr );
    }
    ...
    if ( input.length > 0 ) {
      CheckResult cr =
        new CheckResult( CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(
          PKG, "ImpalaOutputMeta.CheckResult.ExpectedInputOk" ), stepMeta );
      remarks.add( cr );
    } else {
      CheckResult cr =
        new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(
          PKG, "ImpalaOutputMeta.CheckResult.ExpectedInputError" ), stepMeta );
      remarks.add( cr );
    }
  }
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new ImpalaOutput( stepMeta, stepDataInterface, cnr, transMeta, trans );
  }

  public StepDataInterface getStepData() {
    return new ImpalaOutputData();
  }
      ...
      if ( prev != null && prev.size() > 0 ) {
        if ( !Utils.isEmpty( tableName ) ) {
          ...
          try {
            ...
            retval.setError( BaseMessages.getString( PKG, "ImpalaOutputMeta.Error.ErrorConnecting", dbe
              .getMessage() ) );
          } finally {
            db.disconnect();
          }
        } else {
          retval.setError( BaseMessages.getString( PKG, "ImpalaOutputMeta.Error.NoTable" ) );
        }
      } else {
        retval.setError( BaseMessages.getString( PKG, "ImpalaOutputMeta.Error.NoInput" ) );
      }
    } else {
      retval.setError( BaseMessages.getString( PKG, "ImpalaOutputMeta.Error.NoConnection" ) );
    }
      ...
      try {
        ...
        if ( !Utils.isEmpty( realTableName ) ) {
          ...
          if ( db.checkTableExists( realSchemaName, realTableName ) ) {
            ...
            throw new KettleException( BaseMessages.getString( PKG, "ImpalaOutputMeta.Exception.TableNotFound" ) );
          }
        } else {
          throw new KettleException( BaseMessages.getString( PKG, "ImpalaOutputMeta.Exception.TableNotSpecified" ) );
        }
      } catch ( Exception e ) {
        throw new KettleException(
          BaseMessages.getString( PKG, "ImpalaOutputMeta.Exception.ErrorGettingFields" ), e );
      } finally {
        db.disconnect();
      }
    } else {
      throw new KettleException( BaseMessages.getString( PKG, "ImpalaOutputMeta.Exception.ConnectionNotDefined" ) );
    }
  ...
  @Override public RowMeta getRowMeta( StepDataInterface stepData ) {
    return (RowMeta) ( (ImpalaOutputData) stepData ).insertRowMeta;
  }
  ...
  public void setConnection( String connectionName ) throws KettleException {
    ...
    if ( databaseMeta == null ) {
      String errMsg = BaseMessages.getString( PKG, "ImpalaOutputMeta.Exception.ConnectionUndefined", getParentStepMeta().getName(), connectionName );
      logError( errMsg );
  ...
  public StepDialogInterface getDialog( Shell shell, StepMetaInterface meta, TransMeta transMeta, String name ) {
    return new ImpalaOutputDialog( shell, meta, transMeta, name );
  }
